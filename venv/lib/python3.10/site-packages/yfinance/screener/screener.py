...
PREDEFINED_SCREENER_QUERIES = {
    "aggressive_small_caps": {
        ...
        "query": EqyQy(
            ...
            [
                ...
                EqyQy("lt", ["epsgrowth.lasttwelvemonths", 15]),
            ],
        ),
    },
    "day_gainers": {
        ...
        "query": EqyQy(
            "and",
            [
                EqyQy("gt", ["percentchange", 3]),
                EqyQy("eq", ["region", "us"]),
                EqyQy("gte", ["intradaymarketcap", 2000000000]),
                EqyQy("gte", ["intradayprice", 5]),
                EqyQy("gt", ["dayvolume", 15000]),
            ],
        ),
    },
    "day_losers": {
        ...
        "query": EqyQy(
            "and",
            [
                EqyQy("lt", ["percentchange", -2.5]),
                EqyQy("eq", ["region", "us"]),
                EqyQy("gte", ["intradaymarketcap", 2000000000]),
                EqyQy("gte", ["intradayprice", 5]),
                EqyQy("gt", ["dayvolume", 20000]),
            ],
        ),
    },
    "growth_technology_stocks": {
        ...
        "query": EqyQy(
            "and",
            [
                EqyQy("gte", ["quarterlyrevenuegrowth.quarterly", 25]),
                EqyQy("gte", ["epsgrowth.lasttwelvemonths", 25]),
                EqyQy("eq", ["sector", "Technology"]),
                EqyQy("is-in", ["exchange", "NMS", "NYQ"]),
            ],
        ),
    },
    ...
    "most_shorted_stocks": {
        ...
        "query": EqyQy(
            ...
            [
                EqyQy("eq", ["region", "us"]),
                EqyQy("gt", ["intradayprice", 1]),
                EqyQy("gt", ["avgdailyvol3m", 200000]),
            ],
        ),
    },
    "small_cap_gainers": {
        ...
        "query": EqyQy(
            "and",
            [
                EqyQy("lt", ["intradaymarketcap", 2000000000]),
                EqyQy("is-in", ["exchange", "NMS", "NYQ"]),
            ],
        ),
    },
    "undervalued_growth_stocks": {
        ...
        "query": EqyQy(
            "and",
            [
                EqyQy("btwn", ["peratio.lasttwelvemonths", 0, 20]),
                EqyQy("lt", ["pegratio_5y", 1]),
                EqyQy("gte", ["epsgrowth.lasttwelvemonths", 25]),
                EqyQy("is-in", ["exchange", "NMS", "NYQ"]),
            ],
        ),
    ...
    "undervalued_large_caps": {
        ...
        "query": EqyQy(
            ...
            [
                EqyQy("btwn", ["peratio.lasttwelvemonths", 0, 20]),
                EqyQy("lt", ["pegratio_5y", 1]),
                EqyQy("btwn", ["intradaymarketcap", 10000000000, 100000000000]),
                EqyQy("is-in", ["exchange", "NMS", "NYQ"]),
            ],
        ),
    },
    "conservative_foreign_funds": {
        ...
        "query": FndQy(
            ...
            [
                ...
                FndQy("is-in", ["performanceratingoverall", 4, 5]),
                FndQy("lt", ["initialinvestment", 100001]),
                FndQy("lt", ["annualreturnnavy1categoryrank", 50]),
                FndQy("is-in", ["riskratingoverall", 1, 2, 3]),
                FndQy("eq", ["exchange", "NAS"]),
            ],
        ),
    },
    "high_yield_bond": {
        ...
        "query": FndQy(
            ...
            [
                ...
                FndQy("lt", ["annualreturnnavy1categoryrank", 50]),
                FndQy("is-in", ["riskratingoverall", 1, 2, 3]),
                FndQy("eq", ["categoryname", "High Yield Bond"]),
                FndQy("eq", ["exchange", "NAS"]),
            ],
        ),
    },
    "portfolio_anchors": {
        ...
        "query": FndQy(
            "and",
            [
                FndQy("eq", ["categoryname", "Large Blend"]),
                FndQy("is-in", ["performanceratingoverall", 4, 5]),
                FndQy("lt", ["initialinvestment", 100001]),
                FndQy("lt", ["annualreturnnavy1categoryrank", 50]),
                FndQy("eq", ["exchange", "NAS"]),
    ...
    "solid_large_growth_funds": {
        ...
        "query": FndQy(
            "and",
            [
                FndQy("eq", ["categoryname", "Large Growth"]),
                FndQy("is-in", ["performanceratingoverall", 4, 5]),
                FndQy("lt", ["initialinvestment", 100001]),
                FndQy("lt", ["annualreturnnavy1categoryrank", 50]),
                FndQy("eq", ["exchange", "NAS"]),
    ...
    "solid_midcap_growth_funds": {
        ...
        "query": FndQy(
            "and",
            [
                FndQy("eq", ["categoryname", "Mid-Cap Growth"]),
                FndQy("is-in", ["performanceratingoverall", 4, 5]),
                FndQy("lt", ["initialinvestment", 100001]),
                FndQy("lt", ["annualreturnnavy1categoryrank", 50]),
                FndQy("eq", ["exchange", "NAS"]),
    ...
    "top_mutual_funds": {
        ...
        "query": FndQy(
            "and",
            [
                FndQy("gt", ["intradayprice", 15]),
                FndQy("is-in", ["performanceratingoverall", 4, 5]),
                FndQy("gt", ["initialinvestment", 1000]),
                FndQy("eq", ["exchange", "NAS"]),
            ],
        ),
    },
...
def screen(
    ...
    # Fetch
    response = _data.post(_SCREENER_URL_, body=post_query, params=params_dict)
