...
class Lookup:
    ...
    def __init__(
        self, query: str, session=None, proxy=_SENTINEL_, timeout=30, raise_errors=True
    ):
    ...
    def _fetch_lookup(self, lookup_type="all", count=25) -> dict:
        ...
        try:
            ...
            self._logger.error(
                f"{self.query}: Failed to retrieve lookup results and received faulty response instead."
            )
            data = {}
