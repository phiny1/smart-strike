...
c_names_dict = dict(CHARACTER=np.dtype("c"), **_c_names_dict)
...
if (
    (np.intp().dtype.itemsize != 4 or np.clongdouble().dtype.alignment <= 8)
...
class Type:
    ...
    def __repr__(self):
        return (
            f"Type({self.NAME})|type_num={self.type_num},"
            f" dtype={self.dtype},"
