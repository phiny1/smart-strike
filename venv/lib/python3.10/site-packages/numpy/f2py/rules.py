 ...
 * Generation date: """
    + time.asctime(time.gmtime(generationtime))
    + """
...
rout_rules = [
    ...
    {  # Subroutine
        ...
        "declfortranroutine": {
            l_and(
                l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)
            ): "extern void #F_FUNC#(#fortranname#,#FORTRANNAME#)(#callprotoargument#);",
            l_and(
                l_not(ismoduleroutine), isintent_c, l_not(isdummyroutine)
            ): "extern void #fortranname#(#callprotoargument#);",
            ismoduleroutine: "",
            isdummyroutine: "",
        },
        "routine_def": {
            l_not(
                l_or(ismoduleroutine, isintent_c, isdummyroutine)
            ): '    {"#name#",-1,{{-1}},0,0,(char *)'
            ...
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
            l_and(
                l_not(ismoduleroutine), isdummyroutine
            ): '    {"#name#",-1,{{-1}},0,0,NULL,'
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
        },
        "need": {
        ...
        if (#setjmpbuf#) {
            ...
            {
                l_not(
                    l_or(hascallstatement, isdummyroutine)
                ): "                (*f2py_func)(#callfortran#);"
            },
    ...
    {  # Wrapped function
        ...
        "declfortranroutine": {
            l_not(
                l_or(ismoduleroutine, isdummyroutine)
        ...
        "routine_def": {
            ...
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
            isdummyroutine: '    {"#name#",-1,{{-1}},0,0,NULL,'
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
        },
        "initf2pywraphook": {
            l_not(
    ...
    """
        ...
        "need": {
            l_not(l_or(ismoduleroutine, isdummyroutine)): ["F_WRAPPEDFUNC", "F_FUNC"]
        },
        "callfortranroutine": [
            {
                debugcapi: [
...
"""
            ...
            {
                l_and(
                    debugcapi, l_not(isstringfunction)
                ): """\
    fprintf(stderr,\"debug-capi:Fortran function #ctype# #fortranname#(#callfortran#)\\n\");
"""
            },
    ...
    {  # Scalar function
        "declfortranroutine": {
            l_and(
                l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)
            ): "extern #ctype# #F_FUNC#(#fortranname#,#FORTRANNAME#)(#callprotoargument#);",
            l_and(
                l_not(ismoduleroutine), isintent_c, l_not(isdummyroutine)
        ...
        "routine_def": {
            l_and(l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)): (
                '    {"#name#",-1,{{-1}},0,0,(char *)'
                "  #F_FUNC#(#fortranname#,#FORTRANNAME#),"
                "  (f2py_init_func)#apiname#,doc_#apiname#},"
            ),
...
"""
            ...
            {
                l_and(
                    debugcapi, iscomplexfunction
                ): '    fprintf(stderr,"#routdebugshowvalue#\\n",#name#_return_value.r,#name#_return_value.i);'
            },
            {
                l_and(
                    debugcapi, l_not(iscomplexfunction)
                ): '    fprintf(stderr,"#routdebugshowvalue#\\n",#name#_return_value);'
            },
        ],
        "pyobjfrom": {
            iscomplexfunction: "    #name#_return_value_capi = pyobj_from_#ctype#1(#name#_return_value);"
        },
        "need": [
        ...
        "return": {
            iscomplexfunction: ",#name#_return_value_capi",
...
aux_rules = [
    ...
    {  # Common
        "decl": "    #ctype# #varname#;",
        "frompyobj": {
            hasinitvalue: "    #varname#.r = #init.r#, #varname#.i = #init.i#;"
        },
        "_check": iscomplex,
    },
    # String
    ...
    # Scalararray
    {"_check": l_and(isarray, l_not(iscomplexarray))},  # Common
    {"_check": l_and(isarray, l_not(iscomplexarray), isintent_nothide)},  # Not hidden
    # Integer*1 array
    {"need": "#ctype#", "_check": isint1array, "_depend": ""},
    # Integer*-1 array
    {
        "need": "#ctype#",
    ...
    # Integer*-2 array
    {"need": "#ctype#", "_check": isunsigned_shortarray, "_depend": ""},
    # Integer*-8 array
    {"need": "#ctype#", "_check": isunsigned_long_longarray, "_depend": ""},
    # Complexarray
    {"need": "#ctype#", "_check": iscomplexarray, "_depend": ""},
    # Stringarray
    {
...
arg_rules = [
    ...
    {  # Common
        ...
        "docstropt": {
            isintent_nothide: "#varname#_extra_args : input tuple, optional\\n    Default: ()"
        },
        "docstrcbs": "#cbdocstr#",
        "latexdocstrcbs": "\\item[] #cblatexdocstr#",
        "latexdocstropt": {
            isintent_nothide: "\\item[]{{}\\verb@#varname#_extra_args := () input tuple@{}} --- Extra arguments for call-back function {{}\\verb@#varname#@{}}."
        },
        "decl": [
...
""",
        ...
        CFUNCSMESSPY(\"for #varname#=\",#varname#_cb.capi);""",
                    {
                        l_not(
                            isintent_callback
                        ): """        fprintf(stderr,\"#vardebugshowvalue# (call-back in C).\\n\",#cbname#);"""
                    },
                ]
            },
            """\
    ...
    {  # Common
        "decl": "    #ctype# #varname# = 0;",
        "pyobjfrom": {
            debugcapi: '    fprintf(stderr,"#vardebugshowvalue#\\n",#varname#);'
        },
        "callfortran": {
    ...
    if (f2py_success) {"""
        ...
        "closepyobjfrom": {
            isintent_inout: "    } /*if (f2py_success) of #varname# pyobjfrom*/"
        },
        "need": {isintent_inout: "try_pyarr_from_#ctype#"},
        "_check": l_and(isscalar, l_not(iscomplex), l_not(isstring), isintent_nothide),
    },
    {
        "frompyobj": [
            # hasinitvalue...
    ...
    {  # Common
        "pyobjfrom": {
            isintent_out: "    #varname#_capi = pyobj_from_#ctype#1(#varname#);"
        },
    ...
    {  # Not hidden
        ...
        "pyobjfrom": [
            {
                l_and(
                    isintent_inout, l_not(isintent_c)
                ): "        STRINGPADN(#varname#, slen(#varname#), ' ', '\\0');"
            },
            {
                isintent_inout: """\
    ...
    if (f2py_success) {"""
        ...
        "need": {
            isintent_inout: "try_pyarr_from_#ctype#",
            l_and(isintent_inout, l_not(isintent_c)): "STRINGPADN",
        },
        "_check": l_and(isstring, isintent_nothide),
    },
    {"_check": l_and(isstring, isintent_hide)},  # Hidden
    {
        "frompyobj": {
            debugcapi: '    fprintf(stderr,"#vardebugshowvalue#\\n",slen(#varname#),#varname#);'
        },
    ...
    },
    {
        "frompyobj": [
            ...
            {
                isintent_hide: "    capi_#varname#_as_array = ndarray_from_pyobj("
                "  #atype#,#elsize#,#varname#_Dims,#varname#_Rank,"
                "  capi_#varname#_intent,Py_None,capi_errmess);"
            },
            {
                isintent_nothide: "    capi_#varname#_as_array = ndarray_from_pyobj("
                "  #atype#,#elsize#,#varname#_Dims,#varname#_Rank,"
...
""",
            {isstringarray: "    slen(#varname#) = f2py_itemsize(#varname#);"},
            {
                hasinitvalue: [
    ...
    if (f2py_success) {""",
        ...
        "cleanupfrompyobj": [  # note that this list will be reversed
            ...
            {
                l_not(
                    l_or(isintent_out, isintent_hide)
                ): """\
    if((PyObject *)capi_#varname#_as_array!=#varname#_capi) {
        Py_XDECREF(capi_#varname#_as_array); }"""
            ...
            {
                l_and(
                    isintent_hide, l_not(isintent_out)
                ): """        Py_XDECREF(capi_#varname#_as_array);"""
            },
    ...
    {"need": "#ctype#", "_check": isint1array, "_depend": ""},
    # Integer*-1 array
    {"need": "#ctype#", "_check": isunsigned_chararray, "_depend": ""},
    # Integer*-2 array
    {"need": "#ctype#", "_check": isunsigned_shortarray, "_depend": ""},
    # Integer*-8 array
    {"need": "#ctype#", "_check": isunsigned_long_longarray, "_depend": ""},
...
check_rules = [
    {
        "frompyobj": {
            debugcapi: '    fprintf(stderr,"debug-capi:Checking `#check#\'\\n");'
        },
        "need": "len..",
    },
    {
...
def buildmodule(m, um):
    ...
    needs["typedefs"] += [
        cvar
        for cvar in capi_maps.f2cmap_mapped  #
...
def buildapi(rout):
    ...
    if ismoduleroutine(rout):
        outmess(
            '            Constructing wrapper function "%s.%s"...\n'
    ...
    optargs = stripcomma(
        replace(
            ...
            {"docsignxa": rd["docsignxashort"], "docsignopt": rd["docsignoptshort"]},
        )
    )
    if optargs == "":
    ...
    cfs = stripcomma(
        replace(
            "#callfortran##callfortranappend#",
            {
                "callfortran": rd["callfortran"],
                "callfortranappend": rd["callfortranappend"],
            },
        )
    )
    if len(rd["callfortranappend"]) > 1:
        rd["callcompaqfortran"] = stripcomma(
            replace(
                "#callfortran# 0,#callfortranappend#",
                {
                    "callfortran": rd["callfortran"],
                    "callfortranappend": rd["callfortranappend"],
                },
    ...
    if isinstance(rd["docreturn"], list):
        rd["docreturn"] = (
            stripcomma(replace("#docreturn#", {"docreturn": rd["docreturn"]})) + " = "
        )
    rd["docstrsigns"] = []
    rd["latexdocstrsigns"] = []
