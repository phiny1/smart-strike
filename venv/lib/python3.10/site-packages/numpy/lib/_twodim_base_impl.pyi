...
) -> tuple[NDArray[float64], NDArray[_SCT_complex], NDArray[_SCT_complex],]: ...
@overload
def histogram2d(
...
def histogram2d(
    ...
    density: None | bool = ...,
    weights: None | _ArrayLike1DFloat_co = ...,
) -> tuple[NDArray[float64], NDArray[_SCT_inexact], NDArray[_SCT_inexact],]: ...
@overload
def histogram2d(
...
def histogram2d(
    ...
    density: None | bool = ...,
    weights: None | _ArrayLike1DFloat_co = ...,
) -> tuple[NDArray[float64], NDArray[_SCT_number_co], NDArray[_SCT_number_co],]: ...
@overload
def histogram2d(
    x: _ArrayLike1D[_SCT_inexact],
    y: _ArrayLike1D[_SCT_inexact],
...
def histogram2d(
    ...
    density: None | bool = ...,
    weights: None | _ArrayLike1DFloat_co = ...,
) -> tuple[NDArray[float64], NDArray[np.bool], NDArray[np.bool],]: ...
@overload
def histogram2d(
    x: _ArrayLike1DNumber_co,
    y: _ArrayLike1DNumber_co,
