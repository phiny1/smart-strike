...
from .numerictypes import longlong, intc, int_, float64, complex128, flexible
...
def _make_options_dict(
    ...
    *legacy* and sanity checks.
    ...
    if legacy is False:
        ...
        warnings.warn(
            f"Passing `legacy={legacy!r}` is deprecated.", FutureWarning, stacklevel=3
        )
        options["legacy"] = sys.maxsize
    elif legacy == "1.13":
        options["legacy"] = 113
...
class FloatingFormat:
    ...
    def fillFormat(self, data):
        ...
        if data.size != finite_vals.size:
            ...
            self.pad_left = max(
                self.pad_left,
                len(current_options["nanstr"]) - offset,
...
def _array_repr_implementation(
    ...
    if current_options["legacy"] <= 113 and arr.shape == () and not arr.dtype.names:
        ...
        lst = array2string(
            arr, max_line_width, precision, suppress_small, ", ", prefix, suffix=")"
        )
