...
def test_string_comparisons(op, ufunc, sym, dtypes, aligned):
    ...
    assert_array_equal(np.char.compare_chararrays(arr, arr2, sym, False), expected)
    ...
    assert_array_equal(np.char.compare_chararrays(arr2, arr, sym, False), expected)
...
class TestMethods:
    ...
    @pytest.mark.parametrize("i_dt", [np.int8, np.int16, np.int32, np.int64, np.int_])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("", "xx", 1, 1, -1),
            ("", "xx", MAX, 0, -1),
            pytest.param(99 * "a" + "b", "b", 0, None, 99, id="99*a+b-b-0-None-99"),
            pytest.param(98 * "a" + "ba", "ba", 0, None, 98, id="98*a+ba-ba-0-None-98"),
            pytest.param(100 * "a", "b", 0, None, -1, id="100*a-b-0-None--1"),
            pytest.param(
                30000 * "a" + 100 * "b",
                100 * "b",
                0,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("aaa", "", -10, None, 4),
            ("aaa", "aaaa", 0, None, 0),
            pytest.param(98 * "a" + "ba", "ba", 0, None, 1, id="98*a+ba-ba-0-None-1"),
            pytest.param(
                30000 * "a" + 100 * "b",
                100 * "b",
                0,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (["hello", "helloworld"], ["lo", "worl"], [0, -6], None, [True, False]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("xyxz", "xyxz", ""),
            ("xyxzx", "x", "yxzx"),
            (["xyzzyhelloxyzzy", "hello"], ["xyz", "xyz"], ["helloxyzzy", "hello"]),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("", "xyz", ""),
            ("hello", "", "hello"),
            (["hello    ", "abcdefghijklmnop"], None, ["hello", "abcdefghijklmnop"]),
            ("xyzzyhelloxyzzy", "xyz", "xyzzyhello"),
            ("hello", "xyz", "hello"),
            ("xyxz", "xyxz", ""),
            ("    ", None, ""),
            ("xyxzx", "x", "xyxz"),
            (["xyzzyhelloxyzzy", "hello"], ["xyz", "xyz"], ["xyzzyhello", "hello"]),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("xyxz", "xyxz", ""),
            ("xyxzx", "x", "yxz"),
            (["xyzzyhelloxyzzy", "hello"], ["xyz", "xyz"], ["hello", "hello"]),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("spam, spam, eggs and spam", "spam", "ham", -1, "ham, ham, eggs and ham"),
            ("spam, spam, eggs and spam", "spam", "ham", -1, "ham, ham, eggs and ham"),
            ("spam, spam, eggs and spam", "spam", "ham", 4, "ham, ham, eggs and ham"),
            ("spam, spam, eggs and spam", "spam", "ham", 3, "ham, ham, eggs and ham"),
            ("spam, spam, eggs and spam", "spam", "ham", 2, "ham, ham, eggs and spam"),
            ("spam, spam, eggs and spam", "spam", "ham", 1, "ham, spam, eggs and spam"),
            (
