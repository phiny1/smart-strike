...
class TestRegression:
    ...
    def test_mem_fromiter_invalid_dtype_string(self):
        x = [1, 2, 3]
        assert_raises(ValueError, np.fromiter, list(x), dtype="S")
    ...
    def test_astype_copy(self):
        ...
        assert_(xp.__array_interface__["data"][0] != xpd.__array_interface__["data"][0])
    ...
    def test__array_namespace__(self):
        ...
        with pytest.raises(
            ValueError,
            match='Version "2024.12" of the Array API Standard ' "is not supported.",
        ):
    ...
    def test_repeated_square_consistency(self):
        # gh-26940
        buf = np.array(
            [-5.171866611150749e-07 + 2.5618634555957426e-07j, 0, 0, 0, 0, 0]
        )
    ...
    def test_searchsorted_structured(self):
        # gh-28190
        x = np.array([(0, 1.0)], dtype=[("time", "<i8"), ("value", "<f8")])
        y = np.array((0, 0.0), dtype=[("time", "<i8"), ("value", "<f8")])
        x.searchsorted(y)
