...
def _is_armhf():
    ...
    return (
        platform.machine().startswith("arm") and platform.architecture()[0] == "32bit"
    )
    ...
    def test_complex_shortest_path(self):
        ...
        expected = np.array(
            [
                1.2 + 3.4j,
                -1.47384 + 3.2905616j,
                -3.33577588 + 1.36842949j,
                -3.36011056 - 1.30753855j,
...
class TestLinspace:
    ...
    @pytest.mark.xfail(
        _is_armhf(), reason="ARMHF/AArch32 platforms seem to FTZ subnormals"
    )
