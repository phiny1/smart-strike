...
@overload
def cholesky(
    a: _ArrayLikeFloat_co, /, *, upper: bool = False
) -> NDArray[floating[Any]]: ...
@overload
def cholesky(
    a: _ArrayLikeComplex_co, /, *, upper: bool = False
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
...
@overload
def lstsq(
    a: _ArrayLikeInt_co, b: _ArrayLikeInt_co, rcond: None | float = ...
) -> tuple[NDArray[float64], NDArray[float64], int32, NDArray[float64],]: ...
@overload
def lstsq(
