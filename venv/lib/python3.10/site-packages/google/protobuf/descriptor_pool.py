    ...
    def _CreateDefaultFeatures(self, edition):
        ...
        if edition < self._edition_defaults.minimum_edition:
            raise TypeError(
                ...
                % (
                    ...
                    descriptor_pb2.Edition.Name(self._edition_defaults.minimum_edition),
                )
            )
        if edition > self._edition_defaults.maximum_edition:
            raise TypeError(
                ...
                % (
                    descriptor_pb2.Edition.Name(edition),
                    descriptor_pb2.Edition.Name(self._edition_defaults.maximum_edition),
                )
            )
        found = None
        ...
        if file_proto.name not in self._file_descriptors:
            ...
            for enum_type in file_proto.enum_type:
                file_descriptor.enum_types_by_name[
                    ...
                    enum_type, file_proto.package, file_descriptor, None, scope, True
                )
